...
(let ((colors '(;; Upstream theme color
      ...
      (faces '(;; default / basic faces
               ...
               ;; dired
               (dired-directory :foreground ,dracula-comment :weight normal) ; modified
               ...
               (dired-symlink :foreground ,dracula-cyan :weight normal :slant italic) ; modified
               ...
               ;; eshell
               (eshell-ls-directory :foreground ,dracula-comment :weight bold)
               (eshell-ls-symlink :foreground ,dracula-cyan :weight bold)
               (eshell-ls-executable :foreground ,dracula-green :weight bold)
               (eshell-ls-readonly :foreground ,dracula-pink)
               (eshell-ls-special :foreground ,dracula-pink :weight bold)
               (eshell-ls-missing :foreground ,dracula-red :weight bold)
               (eshell-ls-archive :foreground ,dracula-purple :weight bold)
               (eshell-ls-backup :foreground ,dracula-orange)
               (eshell-ls-product :foreground ,dracula-orange)
               (eshell-ls-clutter :foreground ,dracula-orange :weight bold)
               (eshell-prompt :foreground ,dracula-pink :weight bold)
               ;; tuareg
               (tuareg-font-lock-governing-face :foreground ,dracula-yellow :bold t)
               (tuareg-font-lock-multistage-face :foreground ,dracula-comment :background ,dracula-current :bold t)
               (tuareg-font-lock-line-number-face :foreground ,dracula-current)
               (tuareg-font-lock-operator-face :foreground ,dracula-yellow)
               (tuareg-font-lock-module-face :inherit ,font-lock-type-face)
               (tuareg-font-lock-constructor-face :foreground ,dracula-cyan)
               (tuareg-font-lock-error-face :foreground ,dracula-yellow :background ,dracula-red :bold t)
               (tuareg-font-lock-interactive-output-face :foreground ,dracula-current)
               (tuareg-font-lock-interactive-error-face :inherit ,font-lock-warning-face)
               ;; coq
               (coq-solve-tactics-face :foreground ,dracula-red)
               (coq-cheat-face :background ,dracula-red)
               (proof-declaration-name-face :foreground ,dracula-orange :bold t)
               (proof-tacticals-name-face :foreground ,dracula-purple)
               (proof-tactics-name-face :foreground ,dracula-purple))))
