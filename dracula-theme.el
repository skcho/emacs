...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; eshell
   `(eshell-ls-directory ((,class (:foreground ,comment :weight bold))))
   `(eshell-ls-symlink ((,class (:foreground ,const :weight bold))))
   `(eshell-ls-executable ((,class (:foreground ,func :weight bold))))
   `(eshell-ls-readonly ((,class (:foreground ,keyword))))
   `(eshell-ls-special ((,class (:foreground ,keyword :weight bold))))
   `(eshell-ls-missing ((,class (:foreground ,rainbow-9 :weight bold))))
   `(eshell-ls-archive ((,class (:foreground ,type :weight bold))))
   `(eshell-ls-backup ((,class (:foreground ,builtin))))
   `(eshell-ls-product ((,class (:foreground ,builtin))))
   `(eshell-ls-clutter ((,class (:foreground ,builtin :weight bold))))
   `(eshell-prompt ((,class (:foreground ,keyword :weight bold))))
   ;; tuareg
   `(tuareg-font-lock-governing-face ((,class (:foreground ,str :bold t))))
   `(tuareg-font-lock-multistage-face ((,class (:foreground ,comment :background ,bg5 :bold t))))
   ...
   ;; coq
   `(coq-solve-tactics-face ((,class (:foreground ,rainbow-9))))
   `(coq-cheat-face ((,class (:background ,rainbow-9))))
   `(proof-declaration-name-face ((,class (:foreground ,builtin :bold t))))
   `(proof-tacticals-name-face ((,class (:foreground ,type))))
   `(proof-tactics-name-face ((,class (:foreground ,type))))
  ))
